...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { concert_date: @concert.concert_date, duration: @concert.duration, group_id: @concert.group_id, public: @concert.public } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { concert_date: @concert.concert_date, duration: @concert.duration, group_id: @concert.group_id, public: @concert.public } }
